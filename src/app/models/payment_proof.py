# This file is deprecated. The PaymentProof model is now defined in src/app/models/enrollment.py
# to avoid SQLAlchemy mapper errors due to duplicate class definitions.
